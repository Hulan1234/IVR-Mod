...
public interface KSDPacket {
    ...
    ResourceLocation KSD_PACKET_CREATE_OCTOPUS = new ResourceLocation("ksd", "packet_create_octopus");
    ResourceLocation KSD_PACKET_OCTOPUS_ADD_VALUE = new ResourceLocation("ksd", "packet_octopus_add_value");
