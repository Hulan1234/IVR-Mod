...
public interface KSDPacket {
    ...
    ResourceLocation KSD_PACKET_OPEN_KCR_SINGLE_TICKET_MACHINE_SCREEN = new ResourceLocation("ksd", "ksd_packet_open_kcr_single_ticket_machine_screen");
    ResourceLocation KSD_PACKET_SINGLE_TICKET_PROCESSING = new ResourceLocation("ksd", "ksd_single_packet_ticket_processing");
