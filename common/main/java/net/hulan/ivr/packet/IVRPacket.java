...
public interface IVRPacket {
    ...
    ResourceLocation PACKET_OPEN_MODERN_1ODD_SIGN_SCREEN = new ResourceLocation("ivr", "packet_open_modern_1odd_sign_screen");
    ...
    ResourceLocation PACKET_MODERN_1ODD_SIGN_TYPES = new ResourceLocation("ivr", "packet_modern_1odd_sign_types");
}
