...
public class ModernSign1OddScreen extends ScreenMapper implements IGui {
    ...
    public ModernSign1OddScreen(BlockPos signPos) {
        super(Text.literal(""));
        editingIndex = -1;
        ...
        if (world != null) {
            ...
            if (entity instanceof BlockModernSign.TileEntityModernSign1Odd signEntity) {
    ...
    public void render(PoseStack matrices, int mouseX, int mouseY, float delta) {
        try {
            ...
            RenderModernSign.drawSign(matrices, null, null, font, signPos, signId1[0], (width - SIGN_SIZE * 2) / 2F + 0, 0, SIGN_SIZE, 0, 0, selectedIds1, Direction.UP, 0, (textureId, x, y, size, flipTexture) -> {
            ...
            RenderModernSign.drawSign(matrices, null, null, font, signPos, signId2[0], (width - SIGN_SIZE * 2) / 2F + SIGN_SIZE, 0, SIGN_SIZE, 0, 0, selectedIds2, Direction.UP, 0, (textureId, x, y, size, flipTexture) -> {
                UtilitiesClient.beginDrawingTexture(textureId);
                blit(matrices, (int) x, (int) y, 0, 0, (int) size, (int) size, (int) (flipTexture ? -size : size), (int) size);
            });
            if (editingIndex >= 0) {
                ...
                loopSigns((index, x, y, isBig) -> {
                    ...
                    if (sign != null) {
                        ...
                        RenderModernSign.drawSign(matrices, null, null, font, signPos, signId, (isBig ? xOffsetBig : xOffsetSmall) + x + (moveRight ? SIGN_BUTTON_SIZE * 2 : 0), BUTTON_Y_START + y, SIGN_BUTTON_SIZE, 2, 2, editingIndex == 0 ? selectedIds1 : selectedIds2, Direction.UP, 0, (textureId, x1, y1, size, flipTexture) -> blit(matrices, (int) x1, (int) y1, 0, 0, (int) size, (int) size, (int) (flipTexture ? -size : size), (int) size));
                    }
                }, false);
    ...
    @Override
    public void onClose() {
        IVRPacketTrainDataGuiClient.sendModernSign1OddIdsC2S(signPos, selectedIds1, signId1, selectedIds2, signId2, luminance);
        super.onClose();
    }
