...
public class IVR implements ModInitializer, IVRPacket, IVRBlocks, IVRBlockEntityTypes, IVRCreativeModTabs, IPacket {
    ...
    private void init(BiConsumer<String, RegistryObject<Item>> registerItem,
        ...
        registerBlockItem.accept("kcr_single_ticket_machine_mtr", KCR_SINGLE_TICKET_MACHINE_MTR, IVR_);
        registerBlockItem.accept("kcr_single_ticket_machine_kcr", KCR_SINGLE_TICKET_MACHINE_KCR, IVR_);
        registerBlockItem.accept("kcr_single_ticket_machine_light_rail", KCR_SINGLE_TICKET_MACHINE_LIGHT_RAIL, IVR_);
        ...
        registerBlockEntityType.accept("kcr_single_ticket_machine_mtr", KCR_SINGLE_TICKET_MACHINE_MTR_TILE_ENTITY);
        registerBlockEntityType.accept("kcr_single_ticket_machine_kcr", KCR_SINGLE_TICKET_MACHINE_KCR_TILE_ENTITY);
        registerBlockEntityType.accept("kcr_single_ticket_machine_light_rail", KCR_SINGLE_TICKET_MACHINE_LIGHT_RAIL_TILE_ENTITY);
